...
function initializeShop() {
    function render(obj) {
      ...
      obj.tooltip = function(){
          $("#tooltip-"+obj.id).attr("data-original-title",`
      ...
      obj.update = function(){
          document.getElementById("price-"+this.id).innerHTML = "$" + fix(this.price*Math.pow(this.scaling,this.count))
